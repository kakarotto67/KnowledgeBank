...
#### Navigation
- [ASP.NET Building Blocks](Basics.md#aspnet-building-blocks)
- [ASP.NET Configuration File](Basics.md#aspnet-configuration-file)
- [ASP.NET Application Deployment](Basics.md#aspnet-application-deployment)
- [ASP.NET Directives](Basics.md#aspnet-directives)
- [ASP.NET Controls](Basics.md#aspnet-controls)
  - [Control Types](Basics.md#control-types)
  - [Standard Controls](Basics.md#standard-controls)
  - [Validation & Data Source Controls](Basics.md#validation--data-source-controls)
  - [User Controls](Basics.md#user-controls)
  - [Custom Controls](Basics.md#custom-controls)
  - [MS Ajax Controls](Basics.md#ms-ajax-controls)
- [ASP.NET Intrinsic Objects](Basics.md#aspnet-intrinsic-objects)
- [ASP.NET Common](Basics.md#aspnet-common)
  - [File Types](Basics.md#file-types)
  - [Storing of Data](Basics.md#storing-of-data)
  - [Special Folders](Basics.md#special-folders)
  - [Error Handling](Basics.md#error-handling)
  - [ASP.NET IIS](Basics.md#aspnet-iis)
  - [ASP.NET Compiler](Basics.md#aspnet-compiler)
  - [Monitoring](Basics.md#monitoring)
  - [Caching Options](Basics.md#caching-options)
  - [Pass Values Between Pages](Basics.md#pass-values-between-pages)
  - [Add JavaScript Dynamically](Basics.md#add-javascript-dynamically)
- [HTTP Handler (HttpHandler class)](Basics.md#http-handler-httphandler-class)
  - [Generic Handler](Basics.md#generic-handler)
- [HTTP Module (HttpModule class)](Basics.md#http-module-httpmodule-class)
- [Master Pages, Skins and Themes](Basics.md#master-pages-skins-and-themes)
  - [Master Pages](Basics.md#master-pages)
  - [Skins](Basics.md#skins)
  - [Themes](Basics.md#themes)
- [Globalization in ASP.NET](Basics.md#globalization-in-aspnet)
  - [Helper Classes in .NET](Basics.md#helper-classes-in-net)
  - [Localization Resources in ASP.NET](Basics.md#localization-resources-in-aspnet)
- [Application (System.Web.HttpApplication) Class](Basics.md#application-systemwebhttpapplication-class)
  - [Application Life Cycle](Basics.md#application-life-cycle)
  - [Application Events](Basics.md#application-events)
- [Page (System.Web.UI.Page) Class](Basics.md#page-systemwebuipage-class)
  - [Page Life Cycle Events](Basics.md#page-life-cycle-events)
- [Other ASP.NET Features](Basics.md#other-aspnet-features)
  - [Control Adapters](Basics.md#control-adapters)
  - [ASP.NET Web Parts](Basics.md#aspnet-web-parts)
  - [MobileCapabilities API (obsolete)](Basics.md#mobilecapabilities-api-obsolete)
  - [XHTML Standards](Basics.md#xhtml-standards)
...
- `App_Themes` folder - contains web site [themes](Basics.md#themes)
- `App_GlobalResources` folder - contains web site [global resources](Basics.md#localization-resources-in-aspnet)
- `App_LocalResources` folder - contains web site [local resources](Basics.md#localization-resources-in-aspnet)
- `App_Browsers` folder - contains custom [control adapters](Basics.md#control-adapters)
