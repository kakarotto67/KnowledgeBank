...
#### Navigation
- [ASP.NET Building Blocks](ASP.NET/Basics.md#aspnet-building-blocks)
- [ASP.NET Configuration File](ASP.NET/Basics.md#aspnet-configuration-file)
- [ASP.NET Application Deployment](ASP.NET/Basics.md#aspnet-application-deployment)
- [ASP.NET Directives](ASP.NET/Basics.md#aspnet-directives)
- [ASP.NET Controls](ASP.NET/Basics.md#aspnet-controls)
  - [Control Types](ASP.NET/Basics.md#control-types)
  - [Standard Controls](ASP.NET/Basics.md#standard-controls)
  - [Validation & Data Source Controls](ASP.NET/Basics.md#validation--data-source-controls)
  - [User Controls](ASP.NET/Basics.md#user-controls)
  - [Custom Controls](ASP.NET/Basics.md#custom-controls)
  - [MS Ajax Controls](ASP.NET/Basics.md#ms-ajax-controls)
- [ASP.NET Intrinsic Objects](ASP.NET/Basics.md#aspnet-intrinsic-objects)
- [ASP.NET Common](ASP.NET/Basics.md#aspnet-common)
  - [File Types](ASP.NET/Basics.md#file-types)
  - [Storing of Data](ASP.NET/Basics.md#storing-of-data)
  - [Special Folders](ASP.NET/Basics.md#special-folders)
  - [Error Handling](ASP.NET/Basics.md#error-handling)
  - [ASP.NET IIS](ASP.NET/Basics.md#aspnet-iis)
  - [ASP.NET Compiler](ASP.NET/Basics.md#aspnet-compiler)
  - [Monitoring](ASP.NET/Basics.md#monitoring)
  - [Caching Options](ASP.NET/Basics.md#caching-options)
  - [Pass Values Between Pages](ASP.NET/Basics.md#pass-values-between-pages)
  - [Add JavaScript Dynamically](ASP.NET/Basics.md#add-javascript-dynamically)
- [HTTP Handler (HttpHandler class)](ASP.NET/Basics.md#http-handler-httphandler-class)
  - [Generic Handler](ASP.NET/Basics.md#generic-handler)
- [HTTP Module (HttpModule class)](ASP.NET/Basics.md#http-module-httpmodule-class)
- [Master Pages, Skins and Themes](ASP.NET/Basics.md#master-pages-skins-and-themes)
  - [Master Pages](ASP.NET/Basics.md#master-pages)
  - [Skins](ASP.NET/Basics.md#skins)
  - [Themes](ASP.NET/Basics.md#themes)
- [Globalization in ASP.NET](ASP.NET/Basics.md#globalization-in-aspnet)
  - [Helper Classes in .NET](ASP.NET/Basics.md#helper-classes-in-net)
  - [Localization Resources in ASP.NET](ASP.NET/Basics.md#localization-resources-in-aspnet)
- [Application (System.Web.HttpApplication) Class](ASP.NET/Basics.md#application-systemwebhttpapplication-class)
  - [Application Life Cycle](ASP.NET/Basics.md#application-life-cycle)
  - [Application Events](ASP.NET/Basics.md#application-events)
- [Page (System.Web.UI.Page) Class](ASP.NET/Basics.md#page-systemwebuipage-class)
  - [Page Life Cycle Events](ASP.NET/Basics.md#page-life-cycle-events)
- [Other ASP.NET Features](ASP.NET/Basics.md#other-aspnet-features)
  - [Control Adapters](ASP.NET/Basics.md#control-adapters)
  - [ASP.NET Web Parts](ASP.NET/Basics.md#aspnet-web-parts)
  - [MobileCapabilities API (obsolete)](ASP.NET/Basics.md#mobilecapabilities-api-obsolete)
  - [XHTML Standards](ASP.NET/Basics.md#xhtml-standards)
...
- `App_Themes` folder - contains web site [themes](ASP.NET/Basics.md#themes)
- `App_GlobalResources` folder - contains web site [global resources](ASP.NET/Basics.md#localization-resources-in-aspnet)
- `App_LocalResources` folder - contains web site [local resources](ASP.NET/Basics.md#localization-resources-in-aspnet)
- `App_Browsers` folder - contains custom [control adapters](ASP.NET/Basics.md#control-adapters)
