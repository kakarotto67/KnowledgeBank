...
#### Navigation
- [SDLC Essentials](Basics.md#sdlc-essentials)
- [RUP and AUP](Basics.md#rup-and-aup)
- [Waterfall vs Agile/Scrum vs Agile/Kanban](Basics.md#waterfall-vs-agilescrum-vs-agilekanban)
- [Extreme Programming](Basics.md#extreme-programming)
- [Engineering Process Planning](Basics.md#engineering-process-planning)
  - [Requirements Analysis & Evaluating Technical Feasibility](Basics.md#requirements-analysis--evaluating-technical-feasibility)
  - [Recommending Best Technologies](Basics.md#recommending-best-technologies)
  - [Defining Testing Process](Basics.md#defining-testing-process)
  - [Defining Code Review Process](Basics.md#defining-code-review-process)
  - [Defining Deployment Process](Basics.md#defining-deployment-process)
  - [MS Security Development Lifecycle](Basics.md#ms-security-development-lifecycle)
  - [Evaluating Application Performance](Basics.md#evaluating-application-performance)
  - [Evaluating Team Performance](Basics.md#evaluating-team-performance)
  - [Distributed Teams](Basics.md#distributed-teams)
  - [Technical Leaders](Basics.md#technical-leaders)
- [SCRUM Process](Basics.md#scrum-process)
  - [Scrum Essentials](Basics.md#scrum-essentials)
  - [Scrum vs Kanban](Basics.md#scrum-vs-kanban)
  - [Scaled Agile Framework](Basics.md#scaled-agile-framework)
