...
- [The Simplest AOP Scenario in C#](https://www.codeproject.com/Articles/8414/The-Simplest-AOP-Scenario-in-Csharp)
- [Aspect Oriented Programming Using C# and PostSharp](https://www.codeproject.com/Articles/337564/Aspect-Oriented-Programming-Using-Csharp-and-PostS)
...
- [Unicode, Hexadecimal, Decimal NCR, UTF-8 Converter](http://www.endmemo.com/unicode/unicodeconverter.php)
...
### Performance
- [Comparing performance reports with the Visual Studio Team System Profiler](https://docs.microsoft.com/en-us/archive/blogs/ianhu/comparing-performance-reports-with-the-visual-studio-team-system-profiler)
...
- [Git Workflow Cheatsheet](http://krishnaiitd.github.io/gitcommands/images/GitWorkflow-3.png)
...
## CI/CD
- [Continuous Delivery to Azure Websites with git using custom deployment script](https://chriskirby.net/blog/continuous-delivery-to-azure-websites-with-git-using-custom-deployment-script)
- [Continuous integration and delivery to Azure websites with Bamboo](https://chriskirby.net/blog/continuous-integration-and-delivery-to-azure-websites-with-bamboo)
...
### SDLC
- [Agile software development](https://www.wikiwand.com/en/Agile_software_development#/The_Agile_Manifesto)
...
- [Software Systems Architecture: Working With Stakeholders Using Viewpoints and Perspectives](https://www.amazon.com/Software-Systems-Architecture-Stakeholders-Perspectives/dp/032171833X/ref=sr_1_1)
- [Just Enough Software Architecture: A Risk-Driven Approach](https://www.amazon.com/Just-Enough-Software-Architecture-Risk-Driven/dp/0984618104/ref=sr_1_fkmrnull_1)
- [97 Things Every Software Architect Should Know: Collective Wisdom From The Experts](https://www.amazon.com/Things-Every-Software-Architect-Should/dp/059652269X/ref=sr_1_fkmrnull_1)
